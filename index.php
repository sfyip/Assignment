...
require_once ('php_func/list_rest_func.php');
$returnResult = php_list_best_restaurant_result($_GET["page"]);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="container">
            <div class="panel">
                <div class="panel_title">Find Table</div>
                <div class="panel_content">
            ...
            <div class="panel">
                <div class="panel_title">Best Restaurants</div>
                <div class="panel_content">
                    <div class="rest_list">
                        <!--
